...
├── setHostAlias.ts              // upsert/finsert alias in /etc/hosts
...
├── setPortAlias.ts              // upsert/finsert systemd-socat service
...
3. if finsert and exists → return existing
...
2. if finsert and exists → return existing
